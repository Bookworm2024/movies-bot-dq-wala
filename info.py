...
API_ID = int(environ['API_ID', '21145186'])
API_HASH = environ['API_HASH', 'daa53f4216112ad22b8a8f6299936a46']
BOT_TOKEN = environ['BOT_TOKEN', '7296278954:AAGicNTE7KY0NHRTFzGknH2B5YJOwPJtKbs']
...
AUTH_CHANNEL = [int(auth_channel) for auth_channel in environ.get('AUTH_CHANNEL', '-1002123546604').split() if id_pattern.search(auth_channel)]
...
# MongoDB information
SECONDDB_URI = environ.get('SECONDDB_URI', "mongodb+srv://infohubstore06:6qAAckIWzPuV0ESK@hellsnow.t6axa.mongodb.net/?retryWrites=true&w=majority&appName=hellsnow")
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://infohubstore06:q2K2RBEBKjay9CmN@rainfyre.metv6.mongodb.net/?retryWrites=true&w=majority&appName=rainfyre")
